...
st.set_page_config(page_title="BhavPath - India's Placement DNA", page_icon="🧬", layout="wide")

st.markdown("<h1 style='text-align: center;'>🧬 BhavPath - India's First Placement DNA Test</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>Not your basic predictor, this is your future decoded!</p>", unsafe_allow_html=True)
st.markdown("---")
